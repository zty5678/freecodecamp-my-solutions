...
class UnitTests(unittest.TestCase):
  ...
  def test_square_is_square_and_rectangle(self):
    ...
    self.assertEqual(
      actual, expected,
      'Expected polygon-area-calculator object to be an instance of the Square class and the Rectangle class.'
    )
  ...
  def test_square_string(self):
    ...
    self.assertEqual(
      actual, expected,
      'Expected string representation of polygon-area-calculator to be "Square(side=5)"')
  ...
  def test_area(self):
    ...
    expected = 25
    self.assertEqual(actual, expected, 'Expected area of polygon-area-calculator to be 25')
  ...
  def test_perimeter(self):
    ...
    expected = 20
    self.assertEqual(actual, expected, 'Expected perimeter of polygon-area-calculator to be 20')
  ...
  def test_diagonal(self):
    ...
    self.assertEqual(actual, expected,
                     'Expected diagonal of polygon-area-calculator to be 7.0710678118654755')
  ...
  def test_set_attributes(self):
    ...
    self.assertEqual(
      actual, expected,
      'Expected string representation of polygon-area-calculator after setting new values to be "Square(side=2)"'
    )
    self.sq.set_width(4)
    actual = str(self.sq)
    ...
    self.assertEqual(
      actual, expected,
      'Expected string representation of polygon-area-calculator after setting width to be "Square(side=4)"'
    )
  ...
  def test_square_picture(self):
    ...
    expected = "**\n**\n"
    self.assertEqual(actual, expected,
                     'Expected polygon-area-calculator picture to be different.')
